...
import { RiShieldKeyholeLine, RiLoginBoxLine } from 'react-icons/ri';
          ...
          <div className="rounded-md shadow-sm space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="fan@fifa.com or staff@fifa.com"
                value={email}
          ...
          <div>
            ...
            >
              <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                <RiLoginBoxLine className="h-5 w-5 text-white" aria-hidden="true" />
              </span>
              Sign in
            </button>
          </div>
          <div className="text-sm text-center">
            <Link to="/register" className="font-medium text-primary hover:text-primary-100 dark:text-primary-100">
